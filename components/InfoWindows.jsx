    ...
    return (
        <div className="flex flex-col md:flex-row gap-10 items-center md:items-start" id="queEsWindows">
            <div className="w-full md:w-3/4">
                ...
                <p className="text-md mt-2 text-justify">Windows es un sistema operativo desarrollado por la compañía Microsoft. Consiste en un software conformado por un conjunto de programas que permiten gestionar y controlar el funcionamiento de las partes de un ordenador, como la memoria, el disco de almacenamiento y los dispositivos periféricos, y la ejecución de otros programas y aplicaciones.</p>

                <p className="text-md mt-5 text-justify">La palabra Windows, que proviene del inglés y significa ventanas, alude a la estructura del software que permite visualizar múltiples contenidos (como programas y archivos) organizados en compartimentos o ventanas diferentes.</p>
            </div>
